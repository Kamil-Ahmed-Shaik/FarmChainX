...
public class RetailerService {
    ...
    // GET /retailer/{id}/profile
    public RetailerProfileDTO getProfile(Long id, String username) {
    ...
    // POST /retailer/{id}/profile
    public RetailerProfileDTO updateProfile(Long id, String username, RetailerProfileDTO dto) {
