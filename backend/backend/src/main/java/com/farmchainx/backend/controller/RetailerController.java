...
import com.farmchainx.backend.service.RetailerService;
...
public class RetailerController {
    ...
    public RetailerController(RetailerService service,CropService cropService) {
    ...
    public String transferToRetailer(@PathVariable Long cropId,
        ...
        cropService.transferOwnership(cropId, "RETAILER", retailerId);
